					...
					<div class="container">
						<div id="content">
							...
							<!-- Content -->
								...
								<h3>Alta Equipo</h3>
								<form action="Operaciones.jsp?tipo=alta_equipo" method="post">
									<div class="row gtr-50">
										<div class="">
											<input type="text" name="nombre" id="nombre" placeholder="Nombre del equipo" maxlength="9"/>
										</div>
									<div class="">
										<select id="cod_liga" name="cod_liga" is="ms-dropdown" required style="width:450px" data-child-height="415">
									...
									<div style="padding-top:22px;">
											<ul class="actions">
												<li><input type="submit" name="submit" id="submit" value="Dar de Alta equipo"></li>
