...
<body class="is-preload">
		...
		ArrayList<Jugador> jugadores = controladorBD.todosJugadores();%>
			<!-- Header -->
				<div id="header">
							...
							<!-- Content -->
								...
								<form action="Operaciones.jsp?tipo=baja_jugador" method="post">
									<div class="row gtr-50">
										<div class="">
											<select id="cod_jugador" name="cod_jugador" is="ms-dropdown" required style="width:450px" data-child-height="415">
									...
									<div style="padding-top:22px;">
											<ul class="actions">
												<li><input type="submit" name="submit" id="submit" value="Dar de Baja jugador"></li>
