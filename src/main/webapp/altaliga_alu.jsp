					...
					<div class="container">
						<div id="content">
							...
							<!-- Content -->
								...
								<h3>Alta Liga</h3>
								<form action="Operaciones.jsp?tipo=alta_liga" method="post">
									<div class="row gtr-50">
										<div class="">
											<input type="text" name="nombre" id="nombre" placeholder="Nombre de la liga" maxlength="9"/>
										</div>
										<div class="">
											<input type="text" name="pais" id=""pais"" placeholder="Pais de la liga" maxlength="9"/>
										</div>
									...
									<div style="padding-top:22px;">
											<ul class="actions">
												<li><input type="submit" name="submit" id="submit" value="Dar de Alta liga"></li>
