							...
							<!-- Content -->
								...
								<table class="alt">
									...
									<% BDController controladorBD = new BDController();
										...
										ArrayList<Jugador> jugadoresBD = controladorBD.todosJugadores();
									...
									%>
										...
										<tr>
										  <td width='50' style="text-align: center;"><a href="equipo.jsp?cod_equipo=<%=controladorBD.dameJugador(jugadoresBD.get(i).getCod_jugador()).getCod_equipo()%>" style="border-bottom: none"><img width="50" src="<%out.print("./images/equipos/" + controladorBD.dameJugador(jugadoresBD.get(i).getCod_jugador()).getCod_equipo()+ ".png"); %>" alt="imagenHtml5"></a></td>
