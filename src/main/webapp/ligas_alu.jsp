							...
							<!-- Content -->
								...
								<table class="alt">
									...
									<% BDController controladorBD = new BDController();
										...
										ArrayList<Liga> ligasBD = controladorBD.todasLigas();
										for (int i = 0; i < ligasBD.size(); i++){
								
									%>
									<tbody>
									
										<tr>
											<td width='60' rowspan="2"><a href="liga.jsp?cod_liga=<%=ligasBD.get(i).getCod_liga()%>" style="border-bottom: none"><img width="100" src="<%out.print("./images/ligas/" + ligasBD.get(i).getCod_liga()+ ".png"); %>" alt="imagenHtml5"></a></td>
											<td width='300' colspan="3" style="padding-left: 15px;"><a href="liga.jsp?cod_liga=<%=ligasBD.get(i).getCod_liga()%>" style="font-weight: bold; border-bottom: none"><%out.print(ligasBD.get(i).getNombre()); %></a></td>
									<% 
										ArrayList<Equipo> equiposBD = controladorBD.dameEquiposDeLiga(ligasBD.get(i).getCod_liga());
										for (int j = 0; j < equiposBD.size(); j++){
									%>
											<td rowspan="2" width='60' style="text-align: center;"><a href="equipo.jsp?cod_equipo=<%=equiposBD.get(j).getCod_equipo()%>" style="border-bottom: none"><img width="50" src="<%out.print("./images/equipos/" + equiposBD.get(j).getCod_equipo()+ ".png"); %>" alt="imagenHtml5"></a></td>
									<%} %>
																				
										</tr>
										<tr>
										  
										  <td width='50' style="text-align: left; padding-left: 14px;"><img width="50" src="<%out.print("./images/paises/" + ligasBD.get(i).getPais()+ ".png"); %>" alt="imagenHtml5"></td>
										  <td width='205'></td>
