...
Integer cod_liga = Integer.parseInt(request.getParameter("cod_liga"));%>
					...
					<div class="container">
						<div id="content">
							...
							<!-- Content -->
								...
								<article>
									<img width="100" src="<%out.print("./images/ligas/" + cod_liga + ".png");%>"> </img>
									<header>
										<h2><%out.print(controladorBD.dameLiga(cod_liga).getNombre()); %></h2>
									</header>
								...
								<table class="alt">
									...
									<% 
										...
										ArrayList<Equipo> equiposBD = controladorBD.dameEquiposDeLiga(cod_liga);
									...
									<%} %>
										...
										<tr>
										  <td width='50' style="text-align: center; padding-left: 14px; padding-right: 14px;"><img width="50" src="<%out.print("./images/ligas/" + cod_liga+ ".png"); %>" alt="imagenHtml5"></td>
										  <td width='50' style="text-align: center; padding-left: 14px; padding-right: 14px;"><img width="50" src="<%out.print("./images/paises/" + controladorBD.damePaisLiga(equiposBD.get(i).getCod_liga())+ ".png"); %>" alt="imagenHtml5"></td>
										  <td width='205'></td>
										</tr>
