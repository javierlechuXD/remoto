...
<body class="is-preload">
		...
		Liga ligaEditar = controladorBD.dameLiga(Integer.parseInt(request.getParameter("cod_liga")));%>
			<!-- Header -->
				<div id="header">
					...
					<div class="container">
						<div id="content">
							...
							<!-- Content -->
								...
								<h3>Alta Liga</h3>
								<form action="Operaciones.jsp?tipo=editar_liga&cod_liga=<%=ligaEditar.getCod_liga()%>" method="post">
									<div class="row gtr-50">
										<div class="">
											<input type="text" name="nombre" id="nombre" placeholder="Nombre de la liga" value="<%=ligaEditar.getNombre()%>" maxlength="9" required/>
										</div>
										<div class="">
											<input type="text" name="pais" id=""pais"" placeholder="Pais de la liga" value="<%=ligaEditar.getPais()%>" maxlength="9" required/>
										</div>
